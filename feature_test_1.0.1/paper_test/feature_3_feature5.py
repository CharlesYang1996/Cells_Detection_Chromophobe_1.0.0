...
def step2(cell_id):
    ...
    for m in range(cell_id,cell_id+1):
        ...
        for i in range(1,73):
            ...
            for m in range(0,len(temp_list)):
                ...
                if i==15:
                    cv.circle(img, (round(x_temp), round(y_temp)), 1, (0, 255, 0), -1)
        ...
        file.close()
        #list save >
        plt.plot(distance_from_single_point_to_center_list[1], color="black")
    ...
    cv.imwrite("G:\\2020summer\\Project\\paper images\\feature5_1.bmp",img)
