...
def step4(cell_id):
    display = cv.imread("G:\\2020summer\\Project\\Cell_classfication_1.0.0\\temp.bmp")
    ...
    cv.imwrite("G:\\2020summer\\Project\\Cell_classfication_1.0.0\\output_single\\"+str(cell_id)+".bmp",display)
    #cv.waitKey()
